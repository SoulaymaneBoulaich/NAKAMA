      ...
      <div className="flex flex-col gap-6">
        {Array.isArray(posts) && posts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white/5 rounded-[2rem] border border-dashed border-[var(--border-color)]">
            <p className="text-zinc-500 font-black uppercase tracking-widest italic">No resonance detected in your network.</p>
            <p className="text-zinc-700 text-xs mt-2 uppercase tracking-widest font-bold">Follow architects or communities to manifest content.</p>
          </div>
        )}
      </div>
    </div>
