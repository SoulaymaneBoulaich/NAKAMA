...
const calculateWeightedScore = (data: any) => {
...
export const getRatingByAnimeId = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const upsertRating = async (req: AuthenticatedRequest, res: Response) => {
  try {
