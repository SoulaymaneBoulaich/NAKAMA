...
export const getArenaByCode = async (req, res) => {
    try {
...
export const voteHallOfFame = async (req, res) => {
    try {
        const code = getStringParam(req.params.code);
    ...
    try {
        ...
        const history = arenas.map(a => {
            ...
            if (myTeam === 'JUDGE')
                ...
                if (a.winnerTeam === 'DRAW')
                    result = 'drew';
                else if (a.winnerTeam === myTeam)
                    result = 'won';
                else
                    result = 'lost';
            }
...
//# sourceMappingURL=anijudgeController.js.map