...
export const recordInteraction = async (userId: string, animeId: string, type: InteractionType) => {
  try {
    ...
    updateAffinities(userId, animeId, weight).catch(err => 
...
const updateAffinities = async (userId: string, animeId: string, weight: number) => {
